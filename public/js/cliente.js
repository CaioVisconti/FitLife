...
function adicionar() {
    ...
    <div class="fundo-modal">
        <div class="superior-modal">
            ...
            <div onclick="fecharModal()" class="close-modal">X</div>
        </div>
...
function editarExercicio() {
    ...
    <div class="fundo-modal">
        <div class="superior-modal">
            <span class="titulo-modal-exercicio">Editar Exercício Físico</span>
            <div onclick="fecharModal()" class="close-modal">X</div>
        </div>
        <div class="formulario-modal">
...
function editarPessoal() {
    ...
    <div class="fundo-modal">
        <div class="superior-modal">
            <span class="titulo-modal-pessoal">Editar Dados Pessoais</span>
            <div onclick="fecharModal()" class="close-modal">X</div>
        </div>
        <div class="formulario-modal">
...
function avaliarModal() {
    ...
    if(notaPesquisada == 5) {
        modal.innerHTML = `
            <div class="fundo-modal">
                <div class="superior-modal">
                    <span class="titulo-modal-ava">Avaliar</span>
                    <div onclick="fecharModal()" class="close-modal">X</div>
                </div>
